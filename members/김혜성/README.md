...
## 0519 제출 파일
- `notebooks/김혜성_0519_전처리.ipynb` — 수집(381/381 SUCCESS) + Kiwi 전처리
- `reports/김혜성_0519_전처리.html`
- 핵심: `find_business_report_v2`(결산월 무관+정정 우선순위)로 381 전수 수집. Kiwi `add_user_word(NNP,score=50)`로 **seed 30/30 보존**. 5개 희소 seed(넷제로·산업재해·교육훈련·부패방지·컴플라이언스) 발견 → expanded 확장 근거.
