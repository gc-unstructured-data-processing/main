...
## 0519 제출 파일
- `notebooks/신지영_0519_전처리.ipynb` — 수집 + Kiwi 형태소 전처리 (365 firm-year SUCCESS)
- `reports/신지영_0519_전처리.html`
- 핵심: Kiwi 사용. **사용자 사전 미등록 → seed 30개 중 11개가 전처리 후 0회**(탄소중립·재생에너지 등 복합명사 분리). 통합 시 김혜성 user dict 방식 권장.
